import { c as createComponent, m as maybeRenderHead, b as renderTemplate, a as createAstro, d as addAttribute, r as renderComponent } from './astro/server_zrsD6kNJ.mjs';
...
}, "/Users/ezequiel/github/astro/dev-books/src/components/AmazonLogo.astro", void 0);
...
const $$BuyButton = createComponent(($$result, $$props, $$slots) => {
  ...
  const COL = "COL";
  const country = Astro2.request.headers.get("X-Vercel-IP-Country") ?? COL;
  const storeCountry = country === COL ? "col" : "usa";
...
}, "/Users/ezequiel/github/astro/dev-books/src/components/BuyButton.astro", void 0);

const $$file = "/Users/ezequiel/github/astro/dev-books/src/components/BuyButton.astro";
const $$url = undefined;
